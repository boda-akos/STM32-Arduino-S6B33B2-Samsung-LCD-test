//Mr.Wang init
//databus PB8-15, CD PA15, RS PA14, WR PA13, RESET PB2

//TFT chip may be s6b33b3 !! 0xx10 register -and more- differences to s6b33b2
...
tft.fillScreen(BLACK);
  ...
  for(int i = 0; i<360; i+= 30) {
    ...
    tft.drawLine(xx0, yy0, xx1, yy1, GREEN);
  }
